...
let sliderSlider = new Swiper('.content-main__block', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Dotts
	pagination: {
		el: '.content-main__bullets',
		clickable: true,
	},
	// Arrows
	navigation: {
		nextEl: '.slider__content .arrows-content-main_next',
		prevEl: '.slider__content .arrows-content-main_prev',
	},
	/*
	breakpoints: {
		320: {
...
window.onload = function () {
   ...
   function documentActions(e) {
      ...
      if (window.innerWidth > 767 && isMobile.any()) {
         ...
         // Убираем спойлеры при нажатии на любой участок страницы
